...
import { TotalCategoryDetailTable } from './PendingReceiptTable';
import { Link } from 'react-router-dom';

export const TotalCategoryDetail: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see pending total category."
