...
import { PendingDepreciationDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const PendingDepreciationDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Pending Depreciation detail."
        title="Pending Depreciation Detail"
        icon={
          <Link to="/asset">
            <Box
              sx={{
      ...
      <Paper
        ...
        <PendingDepreciationDetailTable />
      </Paper>
    </Box>
  );
};
