...
import { TotalAssetDetailTable } from './PendingPurchaseOrderDetailTable';
import { Link } from 'react-router-dom';

export const TotalAssetDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see total asset."
        title="Total Asset"
        icon={
          <Link to="/asset">
            <Box
