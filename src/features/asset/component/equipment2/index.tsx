...
import { Equipment2DetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const Equipment2Details: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Equipment by Category 2 detail."
        title="Equipment by Category 2 Detail"
        icon={
          <Link to="/asset">
            <Box
              sx={{
