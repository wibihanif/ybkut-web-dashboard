...
import { TotalPurchaseRequestDetailTable } from './PendingPurchaseRequestDetailTable';

export const PendingPurchaseRequestDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see total Pending Purchase Request detail."
        title="Pending Purchase Request Detail"
        icon={
      ...
      <Paper
        ...
        <TotalPurchaseRequestDetailTable />
      </Paper>
    </Box>
  );
};
