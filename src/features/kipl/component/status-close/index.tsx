...
import { StatusCloseDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const StatusCloseDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Status Close detail."
        title="Status Close Detail"
        icon={
          <Link to="/kipl">
            <Box
              sx={{
