...
import { ArPerformanceDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const ArPerformanceDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see AR Performance detail."
        title="AR Performance Detail"
        icon={
          <Link to="/kipl">
            <Box
              sx={{
