...
import { RegularDoDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const RegularDoDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Siswa Regular DO detail."
        title="Siswa Regular DO Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
