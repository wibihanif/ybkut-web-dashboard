...
import { LulusanRegularDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const LulusanRegularDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Lulusan Regular detail."
        title="Lulusan Regular Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
