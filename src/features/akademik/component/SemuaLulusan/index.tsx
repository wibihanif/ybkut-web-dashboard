...
import { SemuaLulusanDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const SemuaLulusanDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Semua Lulusan detail."
        title="Semua Lulusan Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
