...
import { NonRegularDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';
// import { NonRegularDetailTable } from './TotalEquipmentDetailTable';

export const NonRegularDetailss: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Non Lulusan Regular detail."
        title="Non Lulusan Regular Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
