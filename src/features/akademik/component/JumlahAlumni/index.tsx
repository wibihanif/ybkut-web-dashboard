...
import { JumlahAlumniDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const JumlahAlumniDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Jumlah Alumni detail."
        title="Jumlah Alumni Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
