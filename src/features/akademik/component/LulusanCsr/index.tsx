...
import { LulusanCsrDetailTable } from './TotalEquipmentDetailTable';
import { Link } from 'react-router-dom';

export const LulusanCsrDetails: React.FC = () => {
  return (
    <Box>
      <HeaderPage
        inputComponent={
        ...
        subTitle="This page is used to see Lulusan CSR detail."
        title="Lulusan CSR Detail"
        icon={
          <Link to="/akademik">
            <Box
              sx={{
